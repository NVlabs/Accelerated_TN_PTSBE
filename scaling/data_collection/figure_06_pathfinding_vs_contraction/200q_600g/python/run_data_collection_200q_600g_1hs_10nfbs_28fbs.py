...
"""
Data collection for 200-qubit / 600-gate circuits (1 hyper-sample, 10nfbs_28fbs).
...
NUM_REPEATS = 10
RUNS = [
    {'nqubits': 200, 'ngates': 600, 'num_hyper_samples': 1,
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 200q/600g data collection (1 hypersample, 10 repeats) over pre-generated circuits')
