...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_06_pathfinding_vs_contraction/150q_400g/python/
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_150q_400g_1hs_10nfbs_28fbs.py
'
