...
"""Generate all run scripts for figure_06_pathfinding_vs_contraction.
...
AH6 = "figure_06_pathfinding_vs_contraction"
...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/{AH6}/{q}q_{g}g/python/
