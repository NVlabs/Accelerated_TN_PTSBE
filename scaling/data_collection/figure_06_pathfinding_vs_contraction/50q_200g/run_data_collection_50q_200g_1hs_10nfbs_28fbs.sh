...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_06_pathfinding_vs_contraction/50q_200g/python/
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_50q_200g_1hs_10nfbs_28fbs.py
'
