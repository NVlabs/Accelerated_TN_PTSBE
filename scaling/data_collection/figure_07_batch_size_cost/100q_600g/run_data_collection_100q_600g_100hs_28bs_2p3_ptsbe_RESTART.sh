...
echo "Running experiment (RESTART circuits 7-9)..."
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_07_batch_size_cost/100q_600g/python/
  ...
  echo ""
  echo "Setup complete!"
  echo "=== Starting RESTART (circuits 7-9) ===" 
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_100q_600g_100hs_28bs_2p3_ptsbe_RESTART.py
'
