...
Usage:
    python run_data_collection_100q_600g_100hs_24bs_2p3_ptsbe.py --circuit-dir /path/to/circuits [--dry-run] [--output-dir DIR]
    python run_data_collection_100q_600g_100hs_24bs_2p3_ptsbe.py --circuit-dir /path/to/circuits --summary-only output_dir/benchmark_combined.json
"""
...
RUNS = [
   ...
   'shots_per_batch': '2,2,2,100', 'qubits_per_batch': '24,24,24,28'},
]
