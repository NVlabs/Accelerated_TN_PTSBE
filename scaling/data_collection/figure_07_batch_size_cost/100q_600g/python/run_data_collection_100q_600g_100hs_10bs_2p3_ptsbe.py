...
Usage:
    python run_data_collection_100q_600g_100hs_10bs_2p3_ptsbe.py --circuit-dir /path/to/circuits [--dry-run] [--output-dir DIR]
    python run_data_collection_100q_600g_100hs_10bs_2p3_ptsbe.py --circuit-dir /path/to/circuits --summary-only output_dir/benchmark_combined.json
"""
...
RUNS = [
   ...
   'shots_per_batch': '1,1,1,1,1,2,2,2,100', 'qubits_per_batch': '10,10,10,10,10,10,10,2,28'},
]
