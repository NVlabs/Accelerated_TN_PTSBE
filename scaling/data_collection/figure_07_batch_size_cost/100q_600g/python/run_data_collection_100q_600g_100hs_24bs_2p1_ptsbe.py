...
"""
Data collection for 100-qubit / 600-gate circuits (100 hyper-samples, fbs=28, nfbs=24).

Iterates over all pre-generated circuits in --circuit-dir, running each one
through scaling_comparison_avg.py individually.

Usage:
    python run_data_collection_100q_600g_100hs_24bs_2p1_ptsbe.py --circuit-dir /path/to/circuits [--dry-run] [--output-dir DIR]
    python run_data_collection_100q_600g_100hs_24bs_2p1_ptsbe.py --circuit-dir /path/to/circuits --summary-only output_dir/benchmark_combined.json
"""
...
# ============================================================================
# DATA COLLECTION: nfbs=24, fbs=28
# ============================================================================
...
RUNS = [
   ...
   'shots_per_batch': '1,1,2,100', 'qubits_per_batch': '24,24,24,28'},
]
