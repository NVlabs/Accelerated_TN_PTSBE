...
"""
Data collection for 50-qubit / 200-gate circuits (1 hyper-sample, 10nfbs_28fbs).
...
NUM_REPEATS = 10
RUNS = [
    {'nqubits': 50, 'ngates': 200, 'num_hyper_samples': 1,
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 50q/200g data collection (1 hypersample, 10 repeats) over pre-generated circuits')
