...
"""
Data collection for 150-qubit / 400-gate circuits (1 hyper-sample, 10nfbs_28fbs).
...
NUM_REPEATS = 10
RUNS = [
    {'nqubits': 150, 'ngates': 400, 'num_hyper_samples': 1,
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 150q/400g data collection (1 hypersample, 10 repeats) over pre-generated circuits')
