...
"""
Data collection for 100-qubit / 800-gate circuits (1 hyper-sample, 10nfbs_28fbs).
...
NUM_REPEATS = 10
RUNS = [
    {'nqubits': 100, 'ngates': 800, 'num_hyper_samples': 1,
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 100q/800g data collection (1 hypersample, 10 repeats) over pre-generated circuits')
