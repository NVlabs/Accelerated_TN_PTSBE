...
"""
Data collection for 200-qubit / 1000-gate circuits (1 hyper-sample, 10nfbs_28fbs).

Each of the 10 pre-generated circuits is run 10 times (1 noise sample each)
...
NUM_REPEATS = 10
RUNS = [
    {'nqubits': 200, 'ngates': 1000, 'num_hyper_samples': 1,
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 200q/1000g data collection (1 hypersample, 10 repeats) over pre-generated circuits')
