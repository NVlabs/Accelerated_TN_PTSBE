...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_05_pathfinding_vs_contraction/150q_200g/python/
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_150q_200g_1hs_10nfbs_28fbs.py
'
