...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_04_panel_a_final_batch_size/200q_600g/python/
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_200q_600g_100hs_10nfbs_26fbs.py
'
