...
"""
Data collection for 200-qubit / 600-gate circuits (100 hyper-samples, 10nfbs_24fbs).
...
RUNS = [
    {'nqubits': 200, 'ngates': 600, 'num_hyper_samples': 100,
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 200q/600g data collection over pre-generated circuits')
    default_circuit_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), 'circuits', '200q_600g')
    parser.add_argument('--circuit-dir', type=str, default=default_circuit_dir,
                        help='Directory with pre-generated circuits (from generate_circuits.py). '
                             'Default: data_collection/circuits/200q_600g')
