...
"""
RESTART: 200q/1000g, bs=10 (uniform), ptsbe_nshots=10000, nnoise_samples=1.
Picks up from circuit 5 onward. Circuits 0-4 already completed in original run.
"""
...
print("RESTART run_data_collection (proportional3, circuits 5-9) started", flush=True)
try:
...
RUNS = [
    {'nqubits': 200, 'ngates': 1000, 'num_hyper_samples': 100,
     'ptsbe_nshots': 10000, 'qubits_per_batch': '10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10'},
]
...
def run_all(output_dir, circuit_dir, dry_run=False):
    ...
    START_CIRCUIT = 5
    END_CIRCUIT = min(10, num_circuits)
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 200q/1000g proportional3 (10bs, 10000nshots)')
