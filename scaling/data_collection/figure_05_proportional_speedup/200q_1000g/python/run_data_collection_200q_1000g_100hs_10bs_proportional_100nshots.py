...
"""
Proportional3: 200q/1000g, bs=10 (uniform), ptsbe_nshots=100, nnoise_samples=1.
"""
...
RUNS = [
    {'nqubits': 200, 'ngates': 1000, 'num_hyper_samples': 100,
     'ptsbe_nshots': 100, 'qubits_per_batch': '10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10'},
]
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 200q/1000g proportional3 (10bs, 100nshots)')
