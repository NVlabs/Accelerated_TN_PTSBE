...
"""
Proportional3: 100q/600g, bs=10 (uniform), ptsbe_nshots=10, nnoise_samples=1.
"""
...
RUNS = [
    {'nqubits': 100, 'ngates': 600, 'num_hyper_samples': 100,
     'ptsbe_nshots': 10, 'qubits_per_batch': '10,10,10,10,10,10,10,10,10,10'},
]
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 100q/600g proportional3 (10bs, 10nshots)')
