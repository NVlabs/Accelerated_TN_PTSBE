...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_04_panel_b_proportional_speedup/200q_1000g/python/
  ...
  echo ""
  echo "Setup complete!"
  echo "=== Starting Proportional Sampling 3 ===" 
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_200q_1000g_100hs_10bs_proportional_10000nshots_RESTART.py
'
