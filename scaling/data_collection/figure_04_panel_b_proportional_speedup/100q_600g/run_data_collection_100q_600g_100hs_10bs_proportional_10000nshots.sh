...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_04_panel_b_proportional_speedup/100q_600g/python/
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_100q_600g_100hs_10bs_proportional_10000nshots.py
'
