...
Usage:
    python run_data_collection_100q_600g_100hs_15bs_2p1_ptsbe.py --circuit-dir /path/to/circuits [--dry-run] [--output-dir DIR]
    python run_data_collection_100q_600g_100hs_15bs_2p1_ptsbe.py --circuit-dir /path/to/circuits --summary-only output_dir/benchmark_combined.json
"""
...
RUNS = [
   ...
   'shots_per_batch': '1,1,1,1,2,100', 'qubits_per_batch': '15,15,15,15,12,28'},
]
