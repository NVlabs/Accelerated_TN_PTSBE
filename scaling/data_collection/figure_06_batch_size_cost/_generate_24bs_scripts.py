...
"""Generate all run scripts for nfbs=24 batch size experiments."""
...
# nfbs=24, fbs=28
# 100q: 72 non-final / 24 = 3 remainder 0 → 24,24,24,28
CONFIGS = [
    {'label': '100q_600g', 'nqubits': 100, 'ngates': 600,
     'qubits_per_batch': '24,24,24,28'},
]
...
# SPDX-License-Identifier: Apache-2.0
"""
Data collection for {nqubits}-qubit / {ngates}-gate circuits (100 hyper-samples, fbs=28, nfbs=24).
...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_06_batch_size_cost/{config_label}/python/
