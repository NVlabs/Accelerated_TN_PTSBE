...
"""
Data collection (cuDAQ only) for 100-qubit / 200-gate circuits (100 hyper-samples).
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 100q/200g cuDAQ data collection over pre-generated circuits')
