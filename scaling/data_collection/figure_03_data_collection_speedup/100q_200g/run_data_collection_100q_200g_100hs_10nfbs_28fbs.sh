...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_03_data_collection_speedup/100q_200g/python/
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_100q_200g_100hs_10nfbs_28fbs.py
'
