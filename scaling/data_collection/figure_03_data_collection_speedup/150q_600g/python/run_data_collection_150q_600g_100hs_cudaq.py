...
"""
Data collection (cuDAQ only) for 150-qubit / 600-gate circuits (100 hyper-samples).
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 150q/600g cuDAQ data collection over pre-generated circuits')
