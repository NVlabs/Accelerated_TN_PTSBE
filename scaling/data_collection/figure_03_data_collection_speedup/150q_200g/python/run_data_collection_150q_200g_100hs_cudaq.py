...
"""
Data collection (cuDAQ only) for 150-qubit / 200-gate circuits (100 hyper-samples).
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 150q/200g cuDAQ data collection over pre-generated circuits')
