...
"""
Data collection (cuDAQ only) for 100-qubit / 600-gate circuits (100 hyper-samples).
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 100q/600g cuDAQ data collection over pre-generated circuits')
