...
docker exec $CONTAINER_ID bash -l -c '
  cd /workspace/ptsbe/scaling/data_collection/figure_03_data_collection_speedup/75q_400g/python/
  ...
  PYTHONUNBUFFERED=1 python -u run_data_collection_75q_400g_100hs_10nfbs_28fbs.py
'
