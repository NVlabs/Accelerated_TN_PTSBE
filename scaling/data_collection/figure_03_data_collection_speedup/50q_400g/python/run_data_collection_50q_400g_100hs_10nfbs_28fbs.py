...
"""
Data collection for 50-qubit / 400-gate circuits (100 hyper-samples, 10nfbs_28fbs).
...
RUNS = [
    {'nqubits': 50, 'ngates': 400, 'num_hyper_samples': 100,
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 50q/400g data collection over pre-generated circuits')
    default_circuit_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), 'circuits', '50q_400g')
    parser.add_argument('--circuit-dir', type=str, default=default_circuit_dir,
                        help='Directory with pre-generated circuits (from generate_circuits.py). '
                             'Default: data_collection/circuits/50q_400g')
