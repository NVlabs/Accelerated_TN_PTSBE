...
"""
Data collection (cuDAQ only) for 200-qubit / 1000-gate circuits (100 hyper-samples).
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 200q/1000g cuDAQ data collection over pre-generated circuits')
