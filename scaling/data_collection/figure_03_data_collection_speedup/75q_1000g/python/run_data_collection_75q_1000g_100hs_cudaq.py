...
"""
Data collection (cuDAQ only) for 75-qubit / 1000-gate circuits (100 hyper-samples).
...
def main():
    parser = argparse.ArgumentParser(
        description='Run 75q/1000g cuDAQ data collection over pre-generated circuits')
